...
export type CreateTartarusProfileMutation = {
  __typename?: "Mutation";
...
export type UpdateprofilePictureCidMutation = {
  __typename?: "Mutation";
...
export type TartarusProfileQuery = {
  __typename?: "Query";
  viewer?: {
    __typename?: "CeramicAccount";
    id: string;
    tartarusProfile?: {
      ...
      rooms: {
        ...
        edges?: Array<{
          __typename?: "RoomEdge";
          node?: { __typename?: "Room"; id: string } | null;
        } | null> | null;
      };
    } | null;
  } | null;
...
export type ViewerRoomsWMembersMessagesQueryVariables = Exact<{
  [key: string]: never;
}>;

export type ViewerRoomsWMembersMessagesQuery = {
  __typename?: "Query";
  viewer?: {
    __typename?: "CeramicAccount";
...
export const CreateTartarusProfileDocument = {
  ...
  definitions: [
    {
      ...
      operation: "mutation",
      name: { kind: "Name", value: "CreateTartarusProfile" },
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "CreateTartarusProfileInput" },
            },
          },
        },
      ],
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "tartarusProfile" },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            {
  ...
  CreateTartarusProfileMutation,
  CreateTartarusProfileMutationVariables
>;
export const UpdateprofilePictureCidDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "UpdateprofilePictureCid" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "UpdateTartarusProfileInput" },
            },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "updateTartarusProfile" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "input" },
  ...
  UpdateprofilePictureCidMutation,
...
>;
export const TartarusProfileDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
                ...
                { kind: "Field", name: { kind: "Name", value: "id" } },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "profilePictureCid" },
                      },
                      {
                        kind: "Field",
  ...
  TartarusProfileQuery,
  TartarusProfileQueryVariables
>;
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "roomIndex" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "first" },
...
export const ViewerRoomsWMembersMessagesDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "ViewerRoomsWMembersMessages" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "roomListCount" },
                },
              ],
            },
          },
  ...
  ViewerRoomsWMembersMessagesQuery,
  ViewerRoomsWMembersMessagesQueryVariables
>;
