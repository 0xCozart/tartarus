...
export type Create_TartarusprofileMutation = {
  __typename?: "Mutation";
      ...
      messageList?: {
        ...
        edges?: Array<{
          ...
          node?: {
            ...
            message?: string | null;
            roomId: any;
            room?: { __typename?: "Room"; id: string; key: string } | null;
          } | null;
        } | null> | null;
      } | null;
      tartarusProfile?: {
...
export type TartarusProfileQueryQueryVariables = Exact<{
  [key: string]: never;
}>;

export type TartarusProfileQueryQuery = {
  __typename?: "Query";
  viewer?: {
    __typename?: "CeramicAccount";
    tartarusProfile?: {
...
export const Create_TartarusprofileDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "CREATE_TARTARUSPROFILE" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "i" } },
          type: {
            kind: "NonNullType",
            type: {
              kind: "NamedType",
            ...
            arguments: [
              {
                ...
                value: { kind: "Variable", name: { kind: "Name", value: "i" } },
              },
            ],
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "messageList" },
                        arguments: [
                          {
                            kind: "Argument",
  ...
  Create_TartarusprofileMutation,
  Create_TartarusprofileMutationVariables
>;
export const TartarusProfileQueryDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "TartarusProfileQuery" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
